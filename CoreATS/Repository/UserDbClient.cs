...
namespace CoreATS.Repository
{
    ...
    {
        public List<CandidatesModel> GetAllCandidates(string connString)
        {
            return SqlHelper.ExtecuteProcedureReturnData<List<CandidatesModel>>(connString,
                "sp_GetAllCandidate", r => r.TranslateAsCandidatesList());
        }
